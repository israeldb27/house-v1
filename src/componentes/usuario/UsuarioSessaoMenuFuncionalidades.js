        ...
        return (
            <div className="widget widget-about">
                ...
                <ul className="social_links">
                    <li role="presentation" className="active"><Link to="/ofertasRecebidas/10"       title="" style={{color:'red', fontWeight: '800px', fontSize: '16px'}}> <i className="la la-globe"></i> Ofertas </Link></li>
