...
class IntermediacoesEnviadas extends Component {
    ...
    componentDidMount(){
        let idUsuario = 1;
        IntermediacaoService.listarImoveisIntermediacaoSolEnviadas(idUsuario).then(listaImoveis => {
                                        ...
                                        <div className="main-ws-sec">
                                            ...
                                            <div className="tab-feed st2">
                                                <ul>
                                                    ...
                                                    <li data-tab="feed-dd" >
                                                        <Link to="/intermediacoesFechadas/10" title="">
                                                            <img src="images/ic1.png" alt="" />
                                                            <span>Fechadas</span>
                                                        </Link>
                                                    </li>
...
export default IntermediacoesEnviadas;