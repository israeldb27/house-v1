...
class IntermediacoesRecebidas extends Component {

    constructor() {
        super();
             
        this.state = {
           listaImoveisIntermediacao: [] 
        }
    } 

    componentDidMount(){
        let idUsuario = 1;
        IntermediacaoService.listarImoveisIntermediacaoSolRecebidas(idUsuario).then(listaImoveis => {
            this.setState({listaImoveisIntermediacao: listaImoveis})
        })
    }
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="main-ws-sec">
                                            ...
                                            <div className="tab-feed st2">
                                                <ul>
                                                    <li data-tab="info-dd" className="active">
                                                        <Link to="/intermediacoesRecebidas/10" title="">
                                                            <img src="images/ic2.png" alt="" />
                                                            <span>Recebidas</span>
                                                        </Link>
                                                    </li>
                                                    <li data-tab="feed-dd" >
                                                        <Link to="/intermediacoesEnviadas/10" title="">
                                            ...
                                            {
                                                    this.state.listaImoveisIntermediacao.map(imovel => {
                                                        return (
                                                            <div className="post-bar">
                                                                ...
                                                                <div className="job-status-bar">
                                                                    <ul className="like-com">                                                                    
                                                                        <li> <Link to="/" title="" style={{color: 'red'}}> {imovel.totalSolRecebidas} &nbsp; Solicitações Recebidas </Link></li>
                                                                    </ul>                                                                
                                                                </div>
                                                            </div>
                                                        )
...
export default IntermediacoesRecebidas;