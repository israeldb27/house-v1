...
class IntermediacoesFechadas extends Component {
    ...
    componentDidMount(){
        let idUsuario = 1;
        IntermediacaoService.listarImoveisIntermediacaoFechadas(idUsuario).then(listaImoveis => {
...
export default IntermediacoesFechadas;