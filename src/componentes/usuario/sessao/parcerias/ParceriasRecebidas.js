...
class ParceriasRecebidas extends Component {
    ...
    componentDidMount(){
        let idUsuario = 1;
        ParceriaService.listarImoveisParceriasSolRecebidas(idUsuario).then(listaImoveis => {
...
export default ParceriasRecebidas;