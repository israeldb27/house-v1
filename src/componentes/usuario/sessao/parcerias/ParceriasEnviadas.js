...
class ParceriasEnviadas extends Component {
    ...
    componentDidMount(){
        let idUsuario = 1;
        ParceriaService.listarImoveisParceriasSolEnviadas(idUsuario).then(listaImoveis => {
...
export default ParceriasEnviadas;